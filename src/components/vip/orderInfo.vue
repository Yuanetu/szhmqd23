              ...
              <div class="section clearfix">
                ...
                <div class="right-auto">
                  <div class="bg-wrap" style="min-height: 765px;">
                    <div class="sub-tit">
                      <a @click="goback" style="cursor:pointer;" class="add">
                    ...
                    <div class="form-box accept-box form-box1">
                      <dl class="head form-group">
                        <dd>
                          ...
                          <router-link v-if="orderInfo.status === 1" :to="'/pay?orderid='+orderInfo.id" class="btn-pay"
                            >去付款</router-link
                          >
                          <!---->
                        </dd>
                          ...
                          <tr>
                            <td colspan="7" align="right">
                              ...
                              <p style="font-size: 22px;">
                                应付总金额： <b class="red">￥{{totalAmount}}</b>
                              </p>
                            </td>
                          </tr>
                        </tbody>
